...
namespace CC98.LogOn.Controllers
{
	...
	public class AccountController : Controller
	{
		...
		public AccountController(CC98IdentityDbContext identityDbContext, IDynamicStringLocalizer<AccountController> localizer, CC98PasswordHashService cc98PasswordHashService, IIdentityServerInteractionService interactionService, IClientStore clientStore, IOptions<AppSetting> appSetting)
		{
		...
		public async Task<IActionResult> Register(RegisterViewModel model)
		{
			...
			{
				var user = new CC98User
				{
					Name = model.UserName,
					PasswordHash = CC98PasswordHashService.GetPasswordHash(model.Password)
				};

				if (model.BindToZjuInfoId)
				{
					user.IsVerified = true;
					user.RegisterZjuInfoId = User.GetSubjectId();
				}
